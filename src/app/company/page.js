...
export default function CompanyPage() {
  ...
  if (!company) return <p className="text-red-500 text-center mt-10">Company not found.</p>;
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 pt-28 pb-28 overflow-y-auto min-h-screen">
      ...
      <div className="bg-teal-700 text-white p-6 rounded-lg shadow-md text-center">
        ...
        <p className="text-lg mt-2">ISIN: <span className="font-semibold">{company.isin}</span></p>
      </div>

      {/* Navigation Links */}
      <div className="flex justify-around mt-6 bg-gray-100 p-3 rounded-lg shadow-md">
        <a href="#data" className="text-teal-700 font-semibold hover:underline">📊 Data</a>
        <a href="#api" className="text-teal-700 font-semibold hover:underline">🔗 API Calls</a>
        <a href="#reports" className="text-teal-700 font-semibold hover:underline">📄 Generate Reports</a>
        <a href="#chatbot" className="text-teal-700 font-semibold hover:underline">💬 Finbot</a>
        <a href="#social" className="text-teal-700 font-semibold hover:underline">📢 Announcements</a>
      </div>
      ...
      <div className="mt-10 space-y-10">
        ...
        <section id="data" className="p-6 bg-white rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mt-2">Key financial metrics and performance indicators will be displayed here.</p>
        </section>

        {/* API Calls Section */}
        <section id="api" className="p-6 bg-white rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-teal-700">🔗 API Calls</h2>
          <p className="text-gray-600 mt-2">API endpoints for retrieving company data and integrating with external services.</p>
        </section>
        ...
        <section id="reports" className="p-6 bg-white rounded-lg shadow-md">
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-col mt-2 space-y-2">
              {["Market Trends", "Financial Analysis", "Future Plans", "Risk Factors"].map((question, index) => (
        ...
        <section id="chatbot" className="p-6 bg-white rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-teal-700">💬 FinAI - Financial Analysis Chatbot</h2>
          ...
          <div className="mt-4 border p-4 rounded-md h-80 overflow-y-auto bg-gray-100 flex">
            ...
            <aside className="w-1/4 bg-gray-50 p-4 rounded-lg shadow-md overflow-y-auto">
              <h3 className="text-lg font-semibold text-teal-700">📂 Chat Sessions</h3>
              <ul className="mt-2 space-y-2">
                <li className="p-2 bg-teal-100 rounded-md cursor-pointer hover:bg-teal-200">Session 1</li>
                <li className="p-2 bg-teal-100 rounded-md cursor-pointer hover:bg-teal-200">Session 2</li>
                <li className="p-2 bg-teal-100 rounded-md cursor-pointer hover:bg-teal-200">New Session +</li>
              </ul>
            </aside>
            ...
            <div className="flex-1 flex flex-col ml-4">
              <div className="border p-4 rounded-md h-56 overflow-y-auto bg-gray-100">
                {chatMessages.map((msg, index) => (
                  <div key={index} className={`p-2 my-1 rounded-md max-w-xs ${msg.type === "bot" ? "bg-teal-200 text-teal-900 self-start text-left" : "bg-gray-300 text-gray-900 self-end text-right ml-auto"}`}>
                    <strong>{msg.type === "bot" ? "FinBot: " : "User: "}</strong>{msg.text}
                  </div>
                ))}
              </div>
        ...
        <section id="social" className="p-6 bg-white rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-teal-700">📢 Announcements & Social Media</h2>
          <p className="text-gray-600 mt-2">Financial news, press releases, and social media updates will be displayed here.</p>
        </section>
